...
# sag = ColorpatternSimulator.jetimg2sag(image_path = image_path, v_min=-0.811*um, v_max=1.914*um)
# image_path = r"F:\PHD\GitFiles\diffractsim\BOEproject\test0629\imagefiles\image3.png"  # 你的图片路径
# sag = ColorpatternSimulator.jetimg2sag(image_path = image_path, v_min=-0.641*um, v_max=1.103*um)
# image_path = r"F:\PHD\GitFiles\diffractsim\BOEproject\test0629\imagefiles\image4.png"  # 你的图片路径
# sag = ColorpatternSimulator.jetimg2sag(image_path = image_path, v_min=-0.592*um, v_max=0.925*um)
# image_path = r"F:\PHD\GitFiles\diffractsim\BOEproject\test0629\imagefiles\image5.png"  # 你的图片路径
# sag = ColorpatternSimulator.jetimg2sag(image_path = image_path, v_min=-0.574*um, v_max=0.881*um)
image_path = r"F:\PHD\GitFiles\diffractsim\BOEproject\test0629\imagefiles\image6.png"  # 你的图片路径
sag = ColorpatternSimulator.jetimg2sag(image_path = image_path, v_min=-0.634*um, v_max=1.036*um)
